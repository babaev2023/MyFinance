...
import myfinance.gu.table.TableData;
import myfinance.gu.toolbar.AbstractToolBar;
...
abstract public class RightPanel extends AbstractPanel{
    ...
    protected final void init() {
        ...
        if (panels.length == 0) add(Box.createVerticalStrut(Style.PADDING_PANEL_EMPTY)); //На случай пустоты
